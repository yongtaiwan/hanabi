...
class TestHintBug(unittest.TestCase):
        ...
        if teammate_hand.cards and state.common_view.hint_tokens > 0:
            ...
            if matching_indices:
                ...
                if success:
                    ...
                    self.assertIn("player 2", msg.lower(), f"Message should mention 'player 2' but got: {msg}")
    ...
    def test_console_input_hint_parsing(self):
        ...
        if teammate_hand.cards:
            ...
            self.assertEqual(move.teammate, 1, "Teammate should be index 1 (player 2 in 1-indexed)")
                ...
                if matching:
                    ...
                    if move and not error:
                        ...
                        if success:
                            ...
                            self.assertIn(
                                "player 2", msg.lower() or "player 1", f"Expected message about player 2, got: {msg}"
                            )
